...
const BuscarProducto = ({ productos, modalProducto, setModalProducto, handleAgregarProducto }) => {
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center pt-36">
                    <div className="bg-white p-6 rounded-md w-96 max-h-[80%] overflow-auto">
                        <div className="flex justify-between space-x-3 mb-4">
                            ...
                            <button onClick={() => setModalProducto(false)} className="text-red-500 hover:text-red-600">
                                ❌
                            </button>
                        </div>
                        <input
                        ...
                        <ul className="space-y-2">
                            {productosFiltrados.map(({ codigo, producto, precio }) => (
                                <li key={codigo} className="flex justify-between items-center p-2 border border-gray-200 rounded-md">
                                    ...
                                    <button
                                        onClick={() => handleAgregarProducto({ codigo, producto, precio })}
                        ...
                        <button onClick={() => setModalProducto(false)} className="mt-4 bg-gray-500 text-white p-2 rounded-md hover:bg-gray-600 w-full">
                        Cerrar
                        </button>
                    </div>
                </div>
